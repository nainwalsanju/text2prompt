...
echo "🎉 You can now use text2prompt v2.0!"
echo ""
echo "📱 Menu Bar App:"
echo "  Run: text2prompt"
echo "  Look for the ✦ icon in your menu bar"
echo "  Left-click: Open prompt builder popover"
echo "  Right-click: Context menu (Generate, History, Preferences, Quit)"
echo ""
echo "⌨️ Global Hotkey:"
echo "  Press Cmd+Shift+Space from any app to open the prompt builder"
...
echo "  Configure: default mode, auto-copy, context, history, launch at login"
